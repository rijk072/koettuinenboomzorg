  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white/95 backdrop-blur-xl border-t border-stone-200 shadow-premium-xl">
      <div className="flex">
        <a
          href="tel:0653747696"
          onClick={() => ReactGA.event({ category: 'Contact', action: 'Phone Click', label: 'Sticky Mobile CTA' })}
        ...
        <Link
          to="/contact"
          onClick={() => ReactGA.event({ category: 'Contact', action: 'Offerte Click', label: 'Sticky Mobile CTA' })}
