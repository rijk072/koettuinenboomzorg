...
export const particulierProducts: ProductData[] = [
  ...
  },
  {
    id: '21',
    name: 'Zakken Hout',
    description: 'Premium kwaliteit hout per zak. Ideaal voor openhaard, kachel of vuurkorf. Prijs op aanvraag.',
    detailed_description: 'Hoogwaardige zakken met gedroogd hout, perfect voor gebruik in open haard, houtkachel of vuurkorf. Het hout is goed gedroogd voor optimale verbranding. U ontvangt de actuele prijs na het plaatsen van uw bestelling.',
    price: 0,
    category: 'Tuinproducten',
    image_url: '/images/zakken-hout.jpeg',
    in_stock: true,
    popular: true,
    weight: 'Ca. 15-20 kg per zak',
    composition: 'Gedroogd hardhout',
    benefits: ['Goed gedroogd hout', 'Prijs op aanvraag', 'Gratis afhalen', 'Kant-en-klaar per zak', 'Optimale verbranding', 'Nederlandse kwaliteit'],
