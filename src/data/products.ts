...
export const zakelijkProducts: ProductData[] = [
  {
    ...
    image_url: 'https://placehold.co/600x400/F9D835/1B5E20?text=ECOstyle+OpMaat+Kalk',
    in_stock: true,
    popular: true,
  ...
  },
  {
    ...
    category: 'ECOstyle Professioneel',
    image_url: 'https://placehold.co/600x400/558B2F/FFEB3B?text=ECOstyle+Myco-Gazon',
    in_stock: true,
    popular: true,
  ...
  },
  {
    ...
    volume: '70L per zak',
    category: 'ECOstyle Professioneel',
    image_url: 'https://placehold.co/600x400/FF8F00/1B5E20?text=ECOstyle+Terra-Actif',
    in_stock: true,
    popular: false,
  ...
  },
  {
    ...
    volume: '25 kg per zak',
    category: 'ECOstyle Professioneel',
    image_url: 'https://placehold.co/600x400/AD1457/F8BBD0?text=ECOstyle+Myco-Siertuin',
    in_stock: true,
    popular: false,
    weight: '25 kg per zak',
  ...
  },
  {
    ...
    volume: '25 kg per zak',
    category: 'ECOstyle Professioneel',
    image_url: 'https://placehold.co/600x400/1565C0/90CAF9?text=ECOstyle+Terra-Fertiel',
    in_stock: true,
    popular: false,
    weight: '25 kg per zak',
