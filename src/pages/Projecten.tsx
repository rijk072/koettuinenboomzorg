...
import { ArrowRight, CheckCircle, Palette, Eye } from 'lucide-react';
...
const projects: Project[] = [
  ...
  {
    id: 9,
    title: "Penthouse Terras",
    location: "Eindhoven",
    size: "60m²",
    category: "0-100",
    image: "https://images.pexels.com/photos/1105019/pexels-photo-1105019.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop",
    description: "Luxe terras met jacuzzi en exotische planten"
  }
];
...
const ProjectenPage = () => {
  ...
  const filterButtons = [
    ...
    { key: '0-100', label: '0-100m²' },
    { key: '100-250', label: '100-250m²' },
    { key: '250-500', label: '250-500m²' }
  ];
        ...
        <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-20">
          ...
          <AnimationObserver>
            <div className="flex justify-center mb-12">
              <div className="bg-stone-50 p-2 rounded-2xl inline-flex space-x-2 shadow-soft border border-stone-100">
                {filterButtons.map((button, index) => (
                  <AnimationObserver key={button.key} delay={index * 100}>
                    <button
                      key={button.key}
                      ...
                      className={`px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-300 ${
                        activeFilter === button.key
                          ...
                          : 'text-stone-700 hover:bg-white hover:text-primary-900 hover:shadow-soft'
                      }`}
                    >
                      {button.label}
                    </button>
            ...
            <AnimationObserver>
              <div className="text-center py-16">
                <div className="max-w-md mx-auto">
                  ...
                  <h3 className="text-xl font-semibold text-stone-900 mb-3">Geen projecten gevonden</h3>
                  <p className="text-stone-600">
                    Probeer een andere categorie of bekijk alle projecten.
                  </p>
                </div>
              </div>
            </AnimationObserver>
